...
class Review(BaseModel):
    ...
    key_theme:list[str] = Field(description="Write down all the key themes discussed in review in a list")
    summary:str = Field(description="Give a brief description of summary")
    sentiment:Literal["pos","neg"] = Field(description="Give the sentiment of review as positive or negative")
    ...
    reviewer_name:Optional[str] = Field(default="Nikhil Dhawan",description="Write name of the reviewer")
